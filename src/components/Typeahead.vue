...
export default {
  ...
  methods: {
    ...
    pickSuggestion(suggestion) {
      ...
      this.currentQueryId = suggestion.id;
      let conceptId = document.getElementById("conceptId")
      conceptId.innerHTML = suggestion.id;
      console.log("conceptId", conceptId.innerHTML)
      this.hideSuggestions();
      this.$emit("selected", this.currentQuery, this.currentQueryId);
    },
